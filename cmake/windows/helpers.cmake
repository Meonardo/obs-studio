...
function(set_target_properties_obs target)
  ...
  if(target_type STREQUAL EXECUTABLE)
    ...
    elseif(target STREQUAL inject-helper OR target STREQUAL get-graphics-offsets)
      set(OBS_EXECUTABLE_DESTINATION "${OBS_DATA_DESTINATION}/plugins/win-capture")
    ...
    if(target STREQUAL "${PROJECT_NAME}")
      ...
      target_add_resource(${target} "${CMAKE_CURRENT_SOURCE_DIR}/../AUTHORS"
                          "${OBS_DATA_DESTINATION}/${PROJECT_NAME}/authors")
    endif()
  ...
  elseif(target_type STREQUAL MODULE_LIBRARY)
    ...
    elseif(target STREQUAL graphics-hook)
      set(target_destination "${OBS_DATA_DESTINATION}/plugins/win-capture")
    ...
    elseif(target STREQUAL obs-virtualcam-module)
      set(target_destination "${OBS_DATA_DESTINATION}/plugins/win-dshow")
...
function(target_install_resources target)
  ...
  if(EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/data")
    ...
    if(target IN_LIST obs_module_list)
      set(target_destination "${OBS_DATA_DESTINATION}/plugins/${target}")
    elseif(target STREQUAL "${PROJECT_NAME}")
      set(target_destination "${OBS_DATA_DESTINATION}/${PROJECT_NAME}")
    else()
...
function(_bundle_dependencies target)
  ...
  foreach(library IN LISTS found_dependencies)
    # CEF needs to be placed in plugins directory on Windows, which is handled already
